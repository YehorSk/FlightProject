...
public class InstructorPage extends HttpServlet {
	...
	public void printHead(PrintWriter out) {
	    ...
	    out.println("        </li>");
	    out.println("        <li class=\"nav-item\">");
	    out.println("          <a class=\"nav-link\" href=\"AdminStudentPage\">Manage student</a>");
	    out.println("        </li>");
	    out.println("        <li class=\"nav-item\">");
	    out.println("          <a class=\"nav-link\" href=\"AdminTeacherPage\">Manage teacher</a>");
	    out.println("        </li>");
	    out.println("        <li class=\"nav-item\">");
	    out.println("          <a class=\"nav-link\" href=\"AdminSubjectPage\">Manage subject</a>");
	    out.println("        </li>");
